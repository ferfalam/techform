                        ...
                        <div class="shadow overflow-hidden sm:rounded-md">
                            <div class="px-4 py-3 bg-white sm:p-6">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="title" id="title" v-model="courseData.title" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea type="text" name="description" id="description" v-model="courseData.description" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"></textarea>
                                ...
                                <div>
                                    ...
                                    <div v-for="(episode, index) in courseData.episodes" :key="episode.id">
                                        <label :for="'title-' + index" class="block text-sm font-medium text-gray-700 mt-2">
                                            Titre de l'episode n°{{index + 1}}
                                        </label>
                                        <input type="text" name="title" :id="'id-' + index" v-model="courseData.episodes[index].title" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        ...
                                        <input type="text" name="description" :id="'id-' + index" v-model="courseData.episodes[index].description" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        ...
                                        <input type="text" name="video_url" :id="'id-' + index" v-model="courseData.episodes[index].video_url" class="mb-4 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            ...
                            <div class="px-4 pb-2 bg-gray-50 sm:px-6">
                                <div class="block">
                                    <button class="bg-green-600 rounded py-2 px-4 text-white mb-2" v-if="courseData.episodes.length < 15" @click.prevent="add">+</button>
                                    <button class="bg-red-600 rounded py-2 px-4 text-white  mb-2" v-if="courseData.episodes.length > 1" @click.prevent="remove">🗑️</button>
                                </div>
