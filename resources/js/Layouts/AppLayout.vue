                    ...
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            <div class="ml-3 relative">
                                ...
                                <jet-dropdown v-else align="right" width="48">
                                    <template #trigger>
                                        <jet-nav-link :href="route('login')" class="text-sm text-gray-700">
                                            Login
                                        </jet-nav-link>

                                        <jet-nav-link v-if="canRegister" :href="route('register')" class="ml-4 text-sm text-gray-700">
                                            Register
                                        </jet-nav-link>
                                    </template>
                                </jet-dropdown>
